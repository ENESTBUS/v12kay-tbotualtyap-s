...
exports.run = async (client, message, args) => {
  ...
  message.react("798448647980974110");//emoji id girmeniz yeterli olacaktır
  ...
  lrowsmember.roles.add("797903025426530304");//jail rol id
  const lrowskanal = message.guild.channels.cache.find(c => c.id == "797903205367152667");//JAIL-LOG KANAL ID
